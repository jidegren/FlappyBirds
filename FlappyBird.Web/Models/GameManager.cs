...
namespace FlappyBird.Web.Models
{
    public class GameManager
    {
        ...
        void CheckForCollisions()
        {
            ...
            {
                bool hasCollidedWithBottom = Bird.DistanceFromGround < centeredPipe.GapBottom - 150; //150 the ground
                bool hasCollidedWithTop = Bird.DistanceFromGround + 45 > centeredPipe.GapTop - 150; //150 the ground, 45 bird height
